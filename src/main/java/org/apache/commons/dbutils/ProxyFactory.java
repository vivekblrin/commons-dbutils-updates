...
public class ProxyFactory {
	...
	/*
	 * These methods are utility methods for creating prepared statements with
	 * different options for retrieving auto-generated keys, column indexes, or
	 * column names. Here's what each method does:
	 */	    
    public PreparedStatement createPreparedStatement(final Connection connection, final String sql, final int autoGeneratedKeys) {
        try {
    ...
    public PreparedStatement createPreparedStatement(final Connection connection, final String sql, final int[] columnIndexes) {
        try {
    ...
    public PreparedStatement createPreparedStatement(final Connection connection, final String sql, final String[] columnNames) {
        try {
