...
public class ResultSetIterator implements Iterator<Object[]> {
    ...
    public ResultSetIterator(final ResultSet resultSet, final RowProcessor convert, ExecutorService executorService) {
    ...
    /**
     * Returns the next row asynchronously as a CompletableFuture<Object[]>.
     * @return A CompletableFuture<Object[]> representing the next row.
     * This method allows you to asynchronously retrieve the next row from the ResultSet,
     *  which can be useful for performing non-blocking operations in scenarios 
     *  where waiting for the next row synchronously is not desirable.
     */
    public CompletableFuture<Object[]> nextAsync() {
